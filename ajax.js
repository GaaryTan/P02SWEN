...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"1601234A");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter an 8 Digit Valid Admin Card No");
    }else if(val ==2){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','9');
        document.getElementById('id_card_no').setAttribute('placeholder',"S9712345A");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter a valid NRIC number");
    }else if(val ==3){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','16');
        document.getElementById('id_card_no').setAttribute('placeholder',"5351 8030 2225 5070");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter a valid credit card number");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','16');
