                    ...
                    <form role="form"  data-toggle="validator" method="post" action="ajax.php">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" placeholder="Customer Name" name="complainant_name" required>
                        ...
                        <div class="col-lg-12">
                            <form data-toggle="validator" role="form" method="post" action="ajax.php">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="No. of Days" name="budget" data-error="Enter No. of Days" required>
                                    <div class="help-block with-errors"></div>
                                </div>
